		...
		<div class="row-fluid">
			...
			<div class="span3 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="table.html"><span class="hidden-tablet">文件浏览</span></a></li>
			...
			<script type="text/javascript">
				function create_database(){
					$("#databaselistcontainer").load('<%=request.getContextPath()+"/jsp/createdatabaseform.jsp"%>');
				}
			</script>
			<div class="row-fluid" id="databaselistcontainer">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> database list</h2>
						<div class="box-icon">
					...
					<div class="box-content">	
							<p class="btn-group">
								<button id="database_create" class="btn btn-primary btn-round" onclick="create_database()">create database</button>
							</p>
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <s:iterator value="databaseList" id="s"> 
								<tr>
									...
									<td class="centre">
										<a class="btn btn-danger" href='databaseAction/deleteDatabase?databaseName=<s:property value="s"/>'>
											<i class="icon-trash icon-white"></i> 
											Delete
										</a>
										<a class="btn btn-success" href='databaseAction/create?databaseName=<s:property value="s"/>'>
