				...
				<div class="box span12">
					...
					<div class="box-content">	
							...
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <tbody>
							  <s:iterator value="historyRecordList" id="status"> 
								<tr>
									<td><s:property value="op_record_id"/></td>
									<td><s:property value="op_user_name"/></td>
									<td><s:property value="op_desc"/></td>
									<td><s:property value="op_sql"/></td>
									<td><s:property value="op_ts"/></td>
																		
									<td class="centre">
										<a class="btn btn-danger" href=<%=request.getContextPath()+"/hdfsOperation/?databaseName="%><s:property value="s"/>>
