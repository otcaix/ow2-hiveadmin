					...
					<div class="box-content">	
							...
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <s:iterator value="hiveSqlTemplateList" id="status"> 
								<tr>
									<td>
										<a href=<%=request.getContextPath()+"/hiveSqlTemplate/fetchHiveSqlTemplateList" %><s:property value="temp_name"/>><s:property value="temp_name"/></a>
									</td>
									<td><s:property value="temp_description"/></td>
									<td><s:property value="owner_name"/></td>
									<td><s:property value="temp_content"/></td>
