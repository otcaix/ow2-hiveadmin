				...
				<div class="row-fluid" id="tablelistcontainer">
					<div class="box span12">
						<div class="box-header well">
							...
							<h2>
								<i class="icon-info-sign"></i> Truncate Table
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							...
							<form class="span9"
								action='<%=request.getContextPath() + "/tableaction/truncatetable"%>'>
								<fieldset>
								 ...
								 <fieldset class="form-inline">
									<legend>Delete Some Partition </legend>
									...
									<input type="button" id="add_partition" class=" btn btn-small btn-warning "  value="Add Partition" /> 
									<input	type="button" id="remove_partition"  class="btn btn-small btn-info"  value="Remove Partition" />
								</fieldset> 
								<p>
				
								<div class="form-actions">
									<button class="btn btn-small btn-primary" type="submit"><i class="icon-ok icon-white"></i>Truncate</button>
